...
* The original package name 'com.jabardastcoder.jabardastcoder-backend' is invalid and this project uses 'com.jabardastcoder.jabardastcoder_backend' instead.
...
* [Validation](https://docs.spring.io/spring-boot/3.5.11-SNAPSHOT/reference/io/validation.html)
